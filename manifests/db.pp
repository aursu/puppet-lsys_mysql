# @summary
#   Create and configure a MySQL database (No Deferred functions).
#
...
define lsys_mysql::db (
  ...
  Optional[Array[String]]                        $sql             = undef,
  ...
  Optional[Enum['mysql', 'mariadb']]             $mysql_provider  = undef,
) {
